...
const S: Record<string, Spec> = {
  ...
  /* ── expansion: added-content creatures ── */
  /* act 1 */
  ember_wisp: {
    ramp: "ash", shape: "orb", w: 30, h: 30, float: true,
    front: eyes("ash", { n: 2, y: 46, spread: 7, r: 2.4 }) + embers("ash", 34, 5),
  },
  rust_crawler: {
    ramp: "stone", shape: "squat", w: 46, h: 34,
    back: limbs("stone", 66, 26, 14, 6),
    front: plates("stone", 50, 30, 3) + eyes("stone", { y: 60, spread: 9, r: 2.2 }),
  },
  ash_mite: {
    ramp: "ash", shape: "blob", w: 32, h: 24,
    back: limbs("ash", 70, 22, 11, 6),
    front: eyes("ash", { n: 3, y: 64, spread: 6, r: 1.6 }) + spikes("ash", 60, 20, 4, 5),
  },
  /* act 2 */
  molten_sentinel: {
    ramp: "stone", shape: "shard", w: 46, h: 52,
    front: eyes("stone", { n: 1, y: 46, r: 5 }) + plates("stone", 52, 34, 3)
      + embers("stone", 34, 5),
  },
  bile_spitter: {
    ramp: "bile", shape: "squat", w: 42, h: 38,
    front: eyes("bile", { y: 56, spread: 10, r: 2.6 }) + jaw("bile", 66, 22)
      + embers("bile", 46, 4),
  },
  shriek_bat: {
    ramp: "spectre", shape: "blob", w: 34, h: 30, float: true,
    back: wings("spectre", 42, 30),
    front: eyes("spectre", { y: 52, spread: 8, r: 2.4 }) + jaw("spectre", 60, 16),
  },
  forge_warden: {
    ramp: "ash", shape: "tall", w: 46, h: 62, scale: 1.2,
    front: eyes("ash", { n: 1, y: 38, r: 6 }) + plates("ash", 50, 34, 3)
      + embers("ash", 32, 6) + weapon("ash", "axe"),
  },
  /* act 3 */
  cinder_revenant: {
    ramp: "ash", shape: "draped", w: 40, h: 58,
    front: eyes("ash", { y: 42, spread: 9, r: 2.8 }) + embers("ash", 34, 6)
      + tendrils("ash", 72, 4, 12),
  },
  grave_wraith: {
    ramp: "spectre", shape: "draped", w: 40, h: 60, float: true,
    front: eyes("spectre", { y: 42, spread: 9, r: 3 })
      + tendrils("spectre", 74, 5, 14),
  },
  emberfiend: {
    ramp: "ash", shape: "squat", w: 48, h: 46, scale: 1.15,
    front: eyes("ash", { y: 52, spread: 11, r: 3 }) + horns("ash", 34, 12, 12, 5)
      + jaw("ash", 66, 24) + embers("ash", 40, 6),
  },
  ashbound_colossus: {
    ramp: "stone", shape: "shard", w: 56, h: 60, scale: 1.28,
    front: eyes("stone", { n: 1, y: 44, r: 6.5 }) + plates("stone", 54, 42, 3)
      + spikes("stone", 32, 42, 5, 11),
  },
  cinder_warmother: {
    ramp: "regal", shape: "tall", w: 50, h: 66, scale: 1.38,
